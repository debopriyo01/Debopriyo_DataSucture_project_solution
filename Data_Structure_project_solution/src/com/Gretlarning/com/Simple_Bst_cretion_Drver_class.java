package com.Gretlarning.com;
import java.util.Scanner;
public class Simple_Bst_cretion_Drver_class {
	...
	public static void main(String[] args) {
		...
		while(Status==true) {
			...
			for(int i=0;i<size;i++) {
				...
				System.out.println("The Binary Tree in the assending Order is ");
				InorderAssendingOrder(root);
				System.out.println();
			}
			
		System.out.println("Do you want to Stop Press 0 else Press Any key to Continew");
		...
		System.out.println("Proggram Completed SucssessFully ");
		input.close();
	}
